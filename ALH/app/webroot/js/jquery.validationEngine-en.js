...
//		"timeHMS": { 
//                    "regex": "/[0-3]\d\/[0-1]\d\/\d\d\s[0-2]\d(\:[0-5]\d){2}/",
//                    "alertText": "* Please enter in 00:00:00 format"
//                },([01]?[0-9]|2[0-3])
		"time": {
		    "regex": "/^[0-9][0-9]:[0-5][0-9]$/",
                    "alertText": "* Please use Following Format 00:00"    
		},
		"pdfrequired": { 
                    "regex": "none",
		...
		"password": {
		    "regex": /^(?=.*)\S{6,20}$/,
                    "alertText": "* Invalid Password (* No spaces allowed)"
		},
                "onlyNumberSp": {
                    "regex": /^[0-9\ ]+$/,
		...
		"checkFileSize": {
                    "regex": "none",
                    "alertText": "* Maximum ",
                    "alertText2": " file size allowed"                   
                },
                // --- CUSTOM RULES -- Those are specific to the demos, they can be removed or changed to your likings
                "ajaxUserCall": {
		    "regex": /^[0-9a-zA-Z]+$/,
                    "url": "class/crudEmployee.php?method=checkUser&tbl=employees",
