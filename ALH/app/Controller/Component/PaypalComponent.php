 ...
 */
	//protected $nvpUsername = "seller1-sdd_api1.gmail.com";
        //protected $nvpUsername = "pr-facilitator@patrickrileyproductions.com";
        protected $nvpUsername = "shivendra.aggarwal-facilitator_api1.sebiz.net";

/**
 * API credentials - nvp password
 */
	//protected $nvpPassword = "1395471506";
        //protected $nvpPassword = "1407472753";
        protected $nvpPassword = "1375371003";

/**
 * API credentials - nvp signature
 */
	//protected $nvpSignature = "AFcWxV21C7fd0v3bYYYRCpSSRl31AsCqBk0sFyJgRcPhLWHf0JH1pNke";
        //protected $nvpSignature = "AFcWxV21C7fd0v3bYYYRCpSSRl31A8a1oNN-CNmJt316rg3xg2ZE7t0U";
        protected $nvpSignature = "AFcWxV21C7fd0v3bYYYRCpSSRl31AAsDPqaNksvJB7Ov3JdBoj6YW2PZ";
/**
 ...
 **/
	public function formatDoDirectPaymentNvps($payment) {
		...
		$nvps = array(
			...
			'CURRENCYCODE' => $payment['currency'],		// A 3-character currency code
