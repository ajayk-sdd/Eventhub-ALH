...
?>
 ...
 <script  src="http://www.alisthub.com/app/webroot/js/jquery-1.10.2.js" > </script>
    <script  src="http://www.alisthub.com/app/webroot/js/jquery-ui.js" > </script>
    <link href="http://www.alisthub.com/app/webroot/css/front/style.css" type="text/css" rel="stylesheet">
...
//console.log('Welcome!  Fetching your information.... ');
		...
		/*response.access = s;
               ...
               // console.log(response);exit;
                response.access = s;
            $.post('http://www.alisthub.com/Users/fb_connect', {"data[User]": response}, function(data) {
                  var aftr = '';
               // $( "#dialog" ).dialog();
                   // window.open('http://www.alisthub.com/Users/facebookEventCron', "popupWindow", "width=300,height=300,scrollbars=yes");
                    
                    window.location.href = 'http://www.alisthub.com'+re;
   ...
   function createEvent(name, startTime, endTime, location, description) {
	...
	createEvent(name, startTime,endTime, location, description);
     ...
     function facebookEvents() {
       $("#load_fb").show();
       document.cookie="usernameraj=;expires=Thu, 01 Jan 1970 00:00:01 GMT;";
        FB.getLoginStatus(function(response) {
            var aftr = '';
            if (response.status === 'connected') {
                var uid = response.authResponse.userID;
    ...
    var aa = "/me/events?fields=cover,description,end_time,id,location,name,owner,start_time,ticket_uri,timezone,updated_time,venue&type=attending&limit=30&after="+aft;
       //alert(aa);
       FB.api(aa,
    function (responses) {
      if (responses && !responses.error) {
            responses.uid = uid;
             if (responses.data[0]) {
            $.post('http://www.alisthub.com/Users/fb_events', {"data[events]": responses}, function(data) {
    ...
    var aab = "/me/events?fields=cover,description,end_time,id,location,name,owner,start_time,ticket_uri,timezone,updated_time,venue&type=maybe&limit=30&after="+aftrM;
    ...
    function (responsesmay) {
      if (responsesmay && !responsesmay.error) {
            ...
            $.post('http://www.alisthub.com/Users/fb_events', {"data[events]": responsesmay}, function(data) {
    ...
    var aab = "/me/events?fields=cover,description,end_time,id,location,name,owner,start_time,ticket_uri,timezone,updated_time,venue&type=declined&limit=30&after="+aftrD;
    ...
    function (responsesdec) {
      if (responsesdec && !responsesdec.error) {
            ...
            $.post('http://www.alisthub.com/Users/fb_events', {"data[events]": responsesdec}, function(data) {
    ...
    var aab = "/me/events?fields=cover,description,end_time,id,location,name,owner,start_time,ticket_uri,timezone,updated_time,venue&type=not_replied&limit=30&after="+aftrN;
    ...
    function (responsesnot) {
      if (responsesnot && !responsesnot.error) {
            ...
            $.post('http://www.alisthub.com/Users/fb_events', {"data[events]": responsesnot}, function(data) {
             ...
             { 
              if (red==0) {
                  ...
                  {
                     window.location.href = 'http://www.alisthub.com'+red;
                  }
             }
            });
    ...
    function (response) {
      if (response && !response.error) {
           ...
           $.post('http://www.alisthub.com/Events/totalCount', {"data[eventattendtotal]": response}, function(data) {
    ...
    function (response) {
      if (response && !response.error) {
       ...
       totalCount(eId,event_id);
         ...
         $.post('http://www.alisthub.com/Events/addattendmult', {"data[eventattend]": response}, function(data) {
              //alert(data);
            location.reload(); 
    ...
    function (response) {
      if (response && !response.error) {
       ...
       response.access_token = AccTkn;
         $.post('http://www.alisthub.com/Users/fbacc_link', {"data[fbadded]": response}, function(data) {
              if(data==1)
             {
    ...
    function fbAttEventPostsub(id,user_id,event_id,s,log_in) {
       ...
       FB.api('/me', function(response) {
            ...
            $.post('http://www.alisthub.com/Users/fb_connect', {"data[User]": response}, function(data) {
                 ...
                 {
                     $.post('http://www.alisthub.com/Users/fbacc_check', {"data[User]": response}, function(data) {
                            if (data==2) {
...
FB.api(
    ...
    function asd(id,user_id,event_id) {
       ...
       FB.api('/me?fields=picture,name', function(response) {
          ...
          $.post('http://www.alisthub.com/Events/addattend', {"data[eventattend]": response}, function(data) {
           if (data==0) {
...
FB.api(
    ...
    function (response) {
      ...
      if (response && !response.error) {
       ...
       $.post('http://www.alisthub.com/Events/removeattend', {"data[eventattremove]": remove}, function(data) {
           if(data==1)
           {
...
<?php
mail("dev12sebiz@gmail.com","My subject","adfadf");
