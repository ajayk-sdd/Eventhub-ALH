<section id="cont_wrapper">
    <section class="content">
        <h1 class="main_heading"><?php echo $this->Html->link('Add Banner', '/admin/CmsPages/addSubBanner'); ?></h1>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tabulardata">
                    ...
                    <?php foreach ($banners as $data): ?>
                        <tr>
                            ...
                            <td><?php echo $this->html->image("SubBanner/small/" . $data['Banner']['banner']); ?></td>
                            <td><?php
                            $id = $data["Banner"]["id"];
