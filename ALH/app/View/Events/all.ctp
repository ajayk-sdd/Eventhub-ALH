...
//pr($events);
//die;
// for pagination for eventful
$counter = '';
$adjacents = 3;
$targetpage = "http://".$_SERVER['HTTP_HOST']."/Events/all"; //your file name
...
//echo $is_feature;
            ...
            <div class="clear"></div>
            <?php if(isset($eevent->events->event) && !empty($eevent->events->event)){?>
            <label style="font-size:24px;"><b>Events from Eventful</b></label>
            <?php }?>
            <div class="clear"></div>
            <br>
            <div class="event-container">
