    ...
    <div class="center-block">
        <div class="em-sec">
            ...
            <div class="em-sec-inner">
                <?php
                echo $this->Form->create("Event", array('class' => 'event-form', "action" => "editEvent", "id" => "addEvent", 'enctype' => 'multipart/form-data'));
                echo $this->Form->hidden("Event.id");
                echo $this->Form->hidden("Event.referer", array("value" => $referer));
...
<!--                    <label><strong>Is this Event Public or Private?</strong></label>-->
                    ...
                    <div class="location" style="margin-bottom: 10px; overflow:hidden;">
                        ...
                        <div class="fields" style="float: left; width: 50%;">
                            ...
                            <div id = "search_fields" class = "<?php echo $search_fields; ?>">
                                ...
                                <br>
                                Within(miles): <?php echo $this->Form->input("within", array("type" => "text", "div" => FALSE, "label" => FALSE, "class" => "validate[required]", "value" => 85)); ?>
                                <br>
                   ...
                   <script type="text/javascript" src="http://cdnjs.cloudflare.com/ajax/libs/jquery/1.8.3/jquery.min.js">
                    ...
                    <table class="priceClass">	
                        <tr><td>
                                <label><strong><br>Ticket Price</strong><span class="red-star">*</span></label>
                            </td></tr>
                ...
                <div class="emsi-part em-pa-rt">
                   ...
                   <?php   echo $this->Form->input("main_info_phone_no", array("type" => "text", "label" => FALSE, "placeholder" => "The phone number of the main contact for your event", "div" => false, "class" => "txtbx-bg validate[required,custom[phone]]", "id" => "main_info_phone_no"));
                   ?> <br> <br>
...
//                        endforeach;
                    ...
                    <label><strong>Ticket Giveaway</strong></label>
                    <div class = "location">
                        ...
                        echo $this->Form->input("Giveaway.no_of_ticket", array("type" => "text", "label" => FALSE, "div" => false, "class" => "txtbx-bg", "placeholder" => "Enter no of ticket"));
                        ?>
                    </div>
                </div>
                <div class="clear"></div>
                ...
                echo $this->Form->input("Save & Continue", array("type" => "submit", "label" => false, "name" => "save", "div" => false, "id" => "sub", "onclick" => "return dateValidate();"));
                echo $this->Form->end();
                ?>                   
            </div>
            <div class="clear"></div>
...
if ($this->data['Event']['recurring_or_not'] == 1) {
    $selTab = "-1";
} else {
    $selTab = "0";
}
...
<script type="text/javascript">
    ...
    $(window).unbind('beforeunload');
            ...
            if ('<?php echo $this->data['Event']['allow_users_to_edit'] ?>' == 1){
    $("#allow_users").show();
    }

    var cnt = "<?php echo count($this->data['EventDate']) ?>";
            for (var i = 0; i < cnt; i++){
