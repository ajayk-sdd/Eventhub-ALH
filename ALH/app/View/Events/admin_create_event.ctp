    ...
    <div class="center-block">
        <div class="em-sec">
            ...
            <div class="em-sec-inner">
                <?php
                echo $this->Form->create("Event", array('class' => 'event-form', "action" => "createEvent", "id" => "addEvent", 'enctype' => 'multipart/form-data'));
                echo $this->Form->hidden("Event.id");
                if (isset($this->data["Event"]["user_id"]))
                    echo $this->Form->hidden("Test.user_id", array("id" => "user_id", "value" => $this->data["Event"]["user_id"]));
                ?>
                <div class="emsi-part em-pa-lt">
                    <?php if (!isset($this->data["Event"]["user_id"])) { ?>
                        <label><strong>User</strong> <span>(Event belong to this user)</span><span class="red-star">*</span></label>
                        <?php echo $this->Form->input("user_id", array("type" => "select", "label" => FALSE, "div" => false, "class" => "txtbx-bg validate[required] ", 'options' => $users)); ?>
                        <br> <br>
                    <?php } ?>
                    ...
                    <div class="location" style="margin-bottom: 10px; display: none;" id = "cant_find_my_address">
                        ...
                        <div style="display:block;" id = "cant_find_address">
                            <label><strong>Saved Address</strong></label>
                            <?php echo $this->Form->input("Event.specify", array("type" => "select", "label" => FALSE, "div" => FALSE, "options" => $saved_address, "empty" => "Select Address", "class" => "sltbx-sm", "onchange" => "javascript:checklocation();", "id" => "specify"));
                            ?>
...
<div id="tabs">
    ...
    <ul>
        ...
        <li><?php echo $this->Html->link('Advanced View', array('action' => 'caln/'.$Id),array("onclick"=>"javascript:removeStarts(1);"))?></li>
...
<!--                        <label><strong>Ticket Price</strong></label>-->
                    <?php //echo $this->Form->input("Event.ticket_price", array("placeholder" => "Please enter ticket price", "type" => "text", "label" => FALSE, "div" => false, "class" => "txtbx-bg validate[required]", "id" => ""));   ?>
                    <?php if (isset($this->data["TicketPrice"]) && !empty($this->data["TicketPrice"])) { ?>
                        <table class="priceClass">	
                            <tr><td>
                                    <label><strong><br>Ticket Price</strong></label>
                                </td></tr>
                    ...
                    <?php } else {
                        ...
                        <table class="priceClass">	
                            ...
                            <tr id="ticket-price" class="tckt-price"> 
                                <td> 
                                    <?php echo $this->Form->input("TicketPrice.ticket_price.", array("placeholder" => "Ticket price", "type" => "text", "label" => FALSE, "div" => false, "class" => "txtbx-bg validate[required]", "id" => "", "style" => "width:190px;")); ?>
                    ...
                    <?php } ?>
                    <div style="display:block;padding-left: 11px;" id="addPrice">
                    ...
                    <?php echo $this->Form->input("Event.video", array("placeholder" => "The URL for your event video (optional)", "type" => "text", "label" => FALSE, "div" => false, "class" => "txtbx-bg", "id" => "video_url")); ?>
                    ...
                    <div class="img-upload-box_new">
                        ...
                        if ($this->data["Event"]["event_from"] == "facebook")
                        {
                            $imgPath = '';
                            $imgPathFly = ''; 
                        }
                        elseif ($this->data["Event"]["event_from"] == "eventful")
                        {
                            $imgPath = '';
                            $imgPathFly = ''; 
                        }
                        else
                        {
                            ...
                            $imgPathFly = "flyerImage/small/"; 
                        }
                        
                        if (!empty($this->data["Event"]["image_name"])) {

                            echo $this->html->image($imgPath . $this->data["Event"]["image_name"]);
                        }
                        if (isset($this->data["Event"]["id"])) {
                        ...
                        ?>
                         <label>This image will be displayed on all public calendar pages, and is recommended to be "400 x 400"</label>
                    </div>
                    <div class="img-upload-box_new">
                        <br>
                        ...
                        if (!empty($this->data["Event"]["flyer_image"])) {
                            ...
                            echo $this->html->image($imgPathFly . $this->data["Event"]["flyer_image"]);
                        }
                    ...
                    <div class="image_event">
                        ...
                        if (!empty($this->data["EventImages"])) {
                            ...
                            foreach ($this->data["EventImages"] as $ei) {
                                ...
                                ?>
                                <div class="cntTag"><?php echo $this->Html->link("Delete", array("controller" => "Events", "action" => "delEventImg", 'admin' => false, base64_encode($ei['id']), $ei['image_name']), array('escape' => false, 'title' => 'Delete', 'class' => "edidlt", "id" => "imgDel", 'onclick' => "return confirm('Are you sure you want to delete this Image ?');")); ?></div>
                                <?php
                            }
                        }
                        ?>
                    ...
                    *Please press CTRL to upload more than 1 secondary image at a time.
                    ...
                    <label>
                        ...
                        <div id="allow_users" style="display:none;" class="allow-user">
                            ...
                            <?php echo $this->Form->input("EventEditedUser.user_email", array("type" => "text", "label" => FALSE, "div" => false, "class" => "txtbx-bg", "id" => "other_email")); ?>
                        </div>
                    </label> 
                </div>
                <div class="emsi-part em-pa-rt">
                    ...
                    <?php echo $this->Form->input("main_info_name", array("placeholder" => "The name of the main contact for your event", "type" => "text", "label" => FALSE, "div" => false, "class" => "txtbx-bg validate[required] ", "id" => "uname")); ?>
                    <br> <br>
                    <label><strong>Email</strong><span class="red-star">*</span></label>
                    <?php echo $this->Form->input("main_info_email", array("placeholder" => "The email of the main contact for your event", "type" => "text", "label" => FALSE, "div" => false, "class" => "txtbx-bg validate[required,custom[email]] ", "id" => "main_info_email")); ?>
                    <br> <br>
                    <label><strong>Phone Number</strong></label>
                    <?php echo $this->Form->input("main_info_phone_no", array("type" => "text", "label" => FALSE, "placeholder" => "The phone number of the main contact for your event", "div" => false, "class" => "txtbx-bg validate[custom[phone]]", "id" => "main_info_phone_no")); ?>
                    <br> <br>

                    <label><strong>Enter a Short Description for your Event</strong></label>
...
//                        endforeach;
                ...
                <br>
                <?php
                /* echo $this->Form->input("Preview Event", array("type" => "submit", "label" => false, "name" => "review")); */
                echo $this->Form->input("Save & Continue", array("type" => "submit", "label" => false, "name" => "save", "div" => false, "onclick"=>"return dateValidate();"));
                echo $this->Form->end();
                ?>                   
            </div>
            <div class="clear"></div>
...
echo $this->Html->script('/js/admin/Events/admin_createEvent');
echo $this->Html->css('jquery-ui');
...
for ($i = 0; $i < 10; $i++) {
    ?>
                {title: '<?php echo "Blog title  " . $i; ?>', content: '<?php echo "Blog Description >> " . $i; ?>'},
    <?php
}
?>
            {
