...
//pr($events);
//die;
?> <?php echo $this->Form->create("Campaigns", array("action" => "chooseEventSingle", "name" => "search_form")); ?>
...
<div class="em-sec">
    ...
    <div class="search-panel inner-contentnew">
        ...
        <h1><div class="search-top">
                ...
                <?php
                echo $this->Form->input("Event.title", array('type' => 'text', 'div' => false, 'label' => false, "placeholder" => "Event Title"));
        ...
        <div class="sp-inner">
            <ul class="sp-hide-content <?php echo $clss; ?>" >
                ...
                <li>
                    ...
                    echo $this->html->link('Clear Search', array('controller' => 'Campaigns', 'action' => 'chooseEventSingle', "clear"), array("class" => "clear-search"));
                    ?>
                ...
                foreach ($events as $event) {
                    ...
                    <li>
                        <section class="rcmnded_events" id="<?php echo 'event_box_' . $event['Event']['id']; ?>">
                            ...
                            <?php echo $this->Html->link("+ Add Event", array("controller" => "Campaigns", "action" => "selectSingleEvent", base64_encode($event["Event"]["id"]), base64_encode($event["Event"]["title"])), array("class" => "btn-addEvent")); ?>
                    ...
                    <li>
                        <section class="rcmnded_events">
                            ...
                            <section class="events_info">
                                ...
                                <?php echo $this->Html->link("+ Add Event", array("controller" => "Campaigns", "action" => "selectEventfulSingleEvent", $evnt_id), array("class" => "btn-addEvent")); ?>
